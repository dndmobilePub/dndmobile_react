    ...
    <section className="project-wrap">
      ...
      <div className="tab-detail tab-2023">
        <div className="accordion-wrap">
          <dl className="">
            <dt className="accordion active">
              진행중인 프로젝트<sup>(16)</sup>
            </dt>
      ...
      <div className="tab-detail tab-2022 on">
        <div className="accordion-wrap">
          <dl>
            ...
            <dd className="panel">
              <ul>
                <li className="ing">
                  <p>
                    마이데이터 2차<span>진행중</span>
                  </p>
                </li>
                <li className="ing">
                  <p>
                    원더카드 서비스 마켓 및 카드신청 개발<span>진행중</span>
                  </p>
                </li>
                <li className="ing">
                  <p>
                    하나머니 APP고도화(요건수립)<span>진행중</span>
                  </p>
                </li>
              </ul>
            </dd>
          ...
          <dl>
            ...
            <dd className="panel">
              <ul>
                ...
                <li className="ing">
                  <p>
                    고령화를 위한 친화적 모바일APP<span>진행중</span>
                  </p>
                </li>
                <li>
                  <p>현대카드 전략적 파트너쉽</p>
          ...
          <dl>
            ...
            <dd className="panel">
              <ul>
                ...
                <li className="ing">
                  <p>
                    e-Capital Market 운영<span>진행중</span>
                  </p>
                </li>
              </ul>
            </dd>
          ...
          <dl>
            <dt className="accordion ">
              SK m&service<sup>(1)</sup>
            </dt>
            <dd className="panel">
              <ul>
                <li className="ing">
                  <p>
                    하이닉스 LMS시스템(SKHU) 구축<span>진행중</span>
                  </p>
                </li>
              </ul>
            </dd>
          ...
          <dl>
            ...
            <dd className="panel">
              <ul>
                <li className="ing">
                  <p>
                    자가진단 안심전세 APP 구축<span>진행중</span>
                  </p>
                </li>
              </ul>
            </dd>
